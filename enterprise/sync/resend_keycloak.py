...
- RESEND_FROM_EMAIL: Email address to use as the sender (default: "OpenHands Team <contact@openhands.ai>")
...
def send_welcome_email(
    ...
    try:
        ...
        params = {
            'from': os.environ.get(
                'RESEND_FROM_EMAIL', 'OpenHands Team <contact@openhands.ai>'
            ),
            'to': [email],
